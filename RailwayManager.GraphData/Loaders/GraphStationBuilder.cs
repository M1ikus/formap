...
{
    /// <summary>
    /// Builder dla RailwayStations z POIs layer (railway=station|halt). Snap do PathfindingGraph.
    /// Port z Unity StationLoader.
    /// </summary>
    public static class GraphStationBuilder
    {
            ...
            GraphVoivodeshipResolver? resolver = null)
        {
            ...
            foreach (var feature in poiFeatures)
            {
                ...
                // Skip tram/subway/light_rail/narrow_gauge/monorail stations — niegrywalne dla mainline.
                ...
                // Plus: niektóre stops są tagged jako railway=halt + <type>=yes — skip
